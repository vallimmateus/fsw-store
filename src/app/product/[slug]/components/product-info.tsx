...
type ProductInfoProps = {
  product: Pick<
    ...
    "totalPrice" | "basePrice" | "description" | "discountPercentage" | "name"
  >;
};
    ...
    <div className="flex flex-col px-5">
      ...
      <div className="flex items-center gap-1">
        ...
        {discountPercentage > 0 && (
          <DiscountBadge className="px-2 py-0.5">
            {discountPercentage}
          </DiscountBadge>
        )}
      </div>
      ...
      <div className="mt-8 flex flex-col gap-3">
        ...
        <p className="text-justify text-sm text-zinc-300">{description}</p>
      </div>
